...
### Open-Source Base IMIS: [Learn in detail about the Integrated Municipal Information System (IMIS).](https://github.com/dncc-imis/.github/blob/master/README.md)

### Detailed GitHub Organization Structure: [Learn more about the Organization Structure.](https://github.com/dncc-imis/.github/blob/master/ORGANIZATION_STRUCTURE.MD)

### Deployment Documentation & Resources: [View Deployment Documentation.](https://github.com/dncc-imis/deployment_documentation)

### User Manuals: [Access IMIS User Guides.](https://github.com/dncc-imis/user_manual)

### Additional Resources: [View Additional Resources.](https://github.com/dncc-imis/additional_resources)

#### IMIS Brochure: [A concise visual overview of IMIS.](https://github.com/dncc-imis/additional_resources/blob/master/IMIS%20Brochure.pdf)

#### IMIS Poster: [A visual summary of IMIS.](https://github.com/dncc-imis/additional_resources/blob/master/IMIS%20Poster.pdf)

#### IMIS Logo - [Standard: The official IMIS logo in its standard format.](https://github.com/dncc-imis/additional_resources/blob/master/IMIS%20Logo%20-%20Standard.png)

#### IMIS Logo - [Inverted: The IMIS logo in an inverted color scheme.](https://github.com/dncc-imis/additional_resources/blob/master/IMIS%20Logo%20-%20Inverted.png)

#### IMIS Full License Text - [CC BY-NC-SA 4.0](https://github.com/dncc-imis/.github/blob/master/LICENSE.md)

#### IMIS Contributing Guideline - [View the Contributing Guideline](https://github.com/dncc-imis/.github/blob/master/CONTRIBUTING.md)

#### IMIS Code of Conduct - [View the Code of Conduct](https://github.com/dncc-imis/.github/blob/master/CODE_OF_CONDUCT.md)
...
### Overview of the Readiness Assessment Framework: [Learn more about the Readiness Assessment Framework.](https://github.com/dncc-imis/additional_resources/blob/master/Resource%20Materials%20for%20Readiness%20Assessment.pdf)

### Building Survey Questionnaire: [Access the Building Survey Questionnaire.](https://github.com/dncc-imis/additional_resources/blob/master/Building%20Questionnaire.pdf)
